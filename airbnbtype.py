...
def register():
    clear_screen()  # Clear the screen before displaying the register form
    while True:
        print("-REGISTER USER-")
        username = input("\nEnter username: ")
...
def user_log_in():
    clear_screen()  # Clear the screen before displaying the login form
    while True:
        print("-LOG-IN USER-")
        username = input("\nEnter your username: ")
...
def logged_in_menu(username):
    clear_screen()  # Clear the screen before displaying the logged-in menu
    while True:
        print("\nAIRBNB - BATANGAS MAIN MENU")
        print(f'\nLogged in as {username}')
        print(f'Current balance: ${user_accounts[username]["money"]}')
        print("Today is Monday.")  # Inform the user about the current day
        print("""
...
def view_available_rentals():
    clear_screen()  # Clear the screen before displaying the available rentals
    ...
    for index, rental in enumerate(available_rentals):
        ...
        # Use string formatting to align the details properly
...
def checkin(username):
    clear_screen()  # Clear the screen before displaying the check-in form
...
def checkout(username):
    clear_screen()  # Clear the screen before displaying the checkout form
    print("Your Bookings:")
...
def bookings(username):
    clear_screen()  # Clear the screen before displaying the bookings
    print("Your Bookings:")
    for index, (property, checkin_day, nights) in enumerate(user_accounts[username]['properties']):
        print(f"{index + 1}. {property['name']} - Checked in on {checkin_day}, {nights} nights")
        print("Days stayed:")
...
def balance(username):
    clear_screen()  # Clear the screen before displaying the balance
    print(f"Current balance: ${user_accounts[username]['money']}")
...
def properties(username):
    clear_screen()  # Clear the screen before displaying the user properties
...
def add_property(username):
    while True:
        ...
        # Set availability for all days to True initially
